...
const z = `${greetings}, ${name_}`;
console.log(z);

let toh = greetings + ', ' + name_;
console.log(toh);
//Задание 11
...
let fahrenheit_1 = `${fahrenheit} градуса по цельсию`;
let celsius_1 = `${celsius} градуса по Цельсию`;
console.log(fahrenheit_1);
console.log(celsius_1);
